...
[![versions](https://img.shields.io/badge/python-3.11%7C3.12%7C3.13-blue)](https://github.com/phlowers/Pycaphlowers)
[![Documentation](https://readthedocs.org/projects/Pycaphlowers/badge/?version=latest)](https://phlowers.readthedocs.io/projects/Pycaphlowers/en/latest)
[![Actions Status](https://github.com/phlowers/Pycaphlowers/actions/workflows/dev-ci.yml/badge.svg)](https://github.com/phlowers/Pycaphlowers/actions)

[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=phlowers_Pycaphlowers&metric=alert_status)](https://sonarcloud.io/dashboard?id=phlowers_Pycaphlowers) [![Coverage](https://sonarcloud.io/api/project_badges/measure?project=phlowers_Pycaphlowers&metric=coverage)](https://sonarcloud.io/dashboard?id=phlowers_Pycaphlowers)

[![pyodide](https://img.shields.io/badge/works_on-pyodide-%237303fc)](https://pyodide.org/en/stable/index.html)


Mechanical calculation package design of power lines pylons

## User

### Environment

Pycaphlowers is using uv for project, python version and dependencies management. You can use uv which is very similar to pip. You can also use other tools compatible with pip.
